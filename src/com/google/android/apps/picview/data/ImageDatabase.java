...
public class ImageDatabase extends AbstractPicViewDatabase {
  ...
  private static final String COLUMN_DESCRIPITON = "description";
  ...
  private static final String[] ALL_COLUMNS = { COLUMN_URL, COLUMN_MODIFIED,
	  COLUMN_NAME, COLUMN_TITLE, COLUMN_CREDIT, COLUMN_DESCRIPITON, COLUMN_GROUP, COLUMN_KEYWORDS,
      COLUMN_BITMAP };
    ...
    if (imageDb == null) {
      imageDb = new ImageDatabase(getUsableDataBase(DATABASE_NAME,
          "CREATE TABLE " + TABLE_NAME + " (" + COLUMN_URL
              ...
              + COLUMN_NAME + " TEXT,"+ COLUMN_TITLE + " TEXT,"
              + COLUMN_CREDIT + " TEXT,"+ COLUMN_DESCRIPITON + " TEXT,"
              + COLUMN_GROUP + " TEXT,"+ COLUMN_KEYWORDS + " TEXT,"
              + COLUMN_BITMAP + " BLOB);"));
    }
    return imageDb;
  }
  ...
  public PhotoCursor query(String url) {
    return new PhotoCursor(db.query(true, TABLE_NAME, null, COLUMN_URL
